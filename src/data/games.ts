...
export const games: Game[] = [
  ...
  },
  {
    ...
    tagline:
      "Drive the Acceleration City map, tune futuristic rides, and use CoBot tools for open-world route challenges.",
    description:
      "Play Acceleration City online in your browser. Drive the 3D city map, test ramps, use CoBot tools, and practice route planning challenges.",
    instructions: [
    ...
    content: [
      {
        ...
        paragraphs: [
          "Acceleration City is a browser-based 3D driving adventure set inside a bright futuristic map. Instead of locking you to one racing lane, Acceleration City lets you explore roads, ramps, rooftops, desert paths, and neon districts while you learn how speed and control change each route.",
          "The Acceleration City browser version uses the external FreeWebGames embed, so there is no local HTML game package stored in this project. Open the frame, let the iframe finish loading, and play Acceleration City online from the browser. If you are looking for a download, this version is built for browser play instead of APK or EXE files.",
          "The route checker gives Acceleration City a practical on-page task before you start driving. Pick a goal, choose the kind of route you want to try, and use the suggestion to decide whether to scout slowly or commit with boost.",
          "For search intent, the important point is simple: the Acceleration City driving game is playable here, with route help, controls, and access notes kept beside the driving frame.",
        ],
      },
      {
        heading: "Acceleration City open-world driving and upgrades",
        paragraphs: [
          "Acceleration City open-world driving mixes exploration with acceleration timing. Cruise through the city to learn the layout, then push harder when a straight road or clean ramp gives you space to build speed. The fun comes from deciding when to drive carefully and when to use the full power of your ride.",
          "Vehicle upgrades change how each Acceleration City route feels. Cars, bikes, trucks, and hovercraft-style rides all support the fantasy of building a better machine for the map in front of you, especially when Acceleration City route planning depends on handling, drift control, and boost timing.",
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          "One reason players search for Hour of Code, CS2N, CS-STEM Network, or coding-related versions of Acceleration City is the CoBot system. CoBot acts like a programmable helper that can support movement, build platforms, or trigger a boost when the setup is right.",
          "You do not need advanced programming experience to enjoy the Acceleration City driving game. The STEM layer works best when you treat it as experimentation: test a trigger, watch how the result changes your path, and adjust the next attempt. That makes Acceleration City approachable for classroom play, coding clubs, robotics fans, and players who like smart driving challenges.",
        ],
      },
      {
        heading: "Acceleration City controls and device support",
        paragraphs: [
          "Acceleration City controls are built around keyboard driving. Use WASD or the arrow keys to accelerate and steer, press Spacebar for handbrake, drift, action, or jump behavior, tap Left Shift for nitro boost, and use R to reset after a bad landing. If the frame does not respond, click inside it once so the browser focuses the iframe.",
          "Desktop Chrome or another modern desktop browser is the safest choice because Acceleration City uses a full 3D web app inside an external iframe. Can you play Acceleration City on iPad? Tablet browsers may load it, but touch controls and network filters can change the experience. Rotate to landscape and wait for the embedded activity to finish loading before judging performance.",
        ],
        bullets: [
      ...
      },
      {
        ...
        paragraphs: [
          "Many players search for Acceleration City because they want the full browser version on a classroom device, Chromebook-style setup, or shared computer. The Acceleration City play page keeps the driving frame close to the guide, explains the controls clearly, and avoids sending players through unrelated downloads.",
          ...
          "For school or shared-device sessions, keep the first Acceleration City goal simple. Load the frame, check that steering works, drive around the nearest open roads, and only then try ramps, rooftops, or CoBot experiments. This keeps the session useful even when the network is slower than expected.",
        ],
      },
      {
        heading: "Acceleration City route planning goals",
        paragraphs: [
          "A good opening session should prove that Acceleration City route planning and controls both work on your device. Start by driving a clean loop around the central streets, then use one ramp, one rooftop path, and one reset so you understand how the frame reacts.",
          "After that, set a small challenge: reach a higher platform, cross a district without crashing, or use boost only after the car is already straight. These Acceleration City route planning goals make the browser version feel more like a skill test than a simple driving sandbox.",
          "If you are using CoBot tools, change only one thing at a time. Testing one trigger, one platform, or one boost point makes it easier to understand what helped and what broke the route. Clear Acceleration City route planning goals keep each test focused.",
        ],
      },
    ],
    category: "racing",
